...
class DataXceiverServer implements Runnable {
  ...
  private final PeerServer peerServer;//serverSocket对象
  private final DataNode datanode;
  /**
    key是该serverSocket进行accept之后产生的连接,value是该连接对应的线程
   */
  private final HashMap<Peer, Thread> peers = new HashMap<Peer, Thread>();
  /**
   * key是该serverSocket进行accept之后产生的连接,value是该连接对应的DataXceiver对象
   */
