...
1.-fs 参数 例如local|namenode:port,表示namenode
2.-jt 参数 例如local|resourcemanager:port 表示ResourceManager
3.-conf 有参数 表示一个configuration file文件位置
4.-D 有参数，property=value形式
5.-libjars 有参数，逗号拆分的jar包全路径
6.-files 有参数,用逗号拆分的文件,copy到map、reduce集群中
7.-archives 有参数,用逗号拆分的在机器上的未归档文件
8.-tokenCacheFile 有参数,tokens文件的文件名
   */
