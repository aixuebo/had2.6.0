...
public class HdfsFileStatus {
  ...
  private final long length;//该文件的大小
  private final boolean isdir;
  private final short block_replication;//备份次数
  private final long blocksize;//该文件每一个block的大小
  ...
  // Used by dir, not including dot and dotdot. Always zero for a regular file.子文件的数量
