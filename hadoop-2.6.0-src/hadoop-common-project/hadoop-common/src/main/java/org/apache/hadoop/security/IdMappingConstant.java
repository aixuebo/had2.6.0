...
public class IdMappingConstant {
  ...
  public final static long USERGROUPID_UPDATE_MILLIS_DEFAULT = 15 * 60 * 1000; // ms,15min 默认值
  public final static long USERGROUPID_UPDATE_MILLIS_MIN = 1 * 60 * 1000; // ms 1min 最小值
  ...
  public static final String STATIC_ID_MAPPING_FILE_KEY = "static.id.mapping.file";//文件对应的key
  public static final String STATIC_ID_MAPPING_FILE_DEFAULT = "/etc/nfs.map";//默认文件
}
