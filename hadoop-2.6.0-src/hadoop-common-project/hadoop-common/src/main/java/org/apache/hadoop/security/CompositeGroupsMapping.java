...
public class CompositeGroupsMapping
  ...
  public static final String MAPPING_PROVIDERS_CONFIG_KEY = GROUP_MAPPING_CONFIG_PREFIX + ".providers";//hadoop.security.group.mapping.providers
  public static final String MAPPING_PROVIDERS_COMBINED_CONFIG_KEY = MAPPING_PROVIDERS_CONFIG_KEY + ".combined";//hadoop.security.group.mapping.providers.combined
  public static final String MAPPING_PROVIDER_CONFIG_PREFIX = GROUP_MAPPING_CONFIG_PREFIX + ".provider";//hadoop.security.group.mapping.provider
  ...
  private boolean combined;//合并,即是否查找到group之后就不再继续查找,true表示合并,即会一直找下去
  ...
  public synchronized List<String> getGroups(String user) throws IOException {
    ...
    for (GroupMappingServiceProvider provider : providersList) {
      ...
      //合并,即是否查找到group之后就不再继续查找,true表示合并,即会一直找下去
  ...
  private void loadMappingProviders() {
    ...
    for (String name : providerNames) {
      providerKey = MAPPING_PROVIDER_CONFIG_PREFIX + "." + name;//hadoop.security.group.mapping.provider.name
