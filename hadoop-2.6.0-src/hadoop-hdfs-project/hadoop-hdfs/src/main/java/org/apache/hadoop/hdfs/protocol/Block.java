 ...
 * long.
 * block文件格式blk_blockID_GenerationStamp.meta
 **************************************************/
...
public class Block implements Writable, Comparable<Block> {
  ...
  /**
   * blk_blockID_GenerationStamp.meta转换为blk_blockID路径
   */
  ...
  private long numBytes;//该block的数据块大小
