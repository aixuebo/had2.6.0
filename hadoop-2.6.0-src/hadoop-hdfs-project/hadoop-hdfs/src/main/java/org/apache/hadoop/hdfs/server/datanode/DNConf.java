...
public class DNConf {
  ...
  final int socketTimeout;//peer.setReadTimeout(dnConf.socketTimeout);
  final int socketWriteTimeout;//peer.setWriteTimeout(datanode.getDnConf().socketWriteTimeout);
  final int socketKeepaliveTimeout;//peer.setReadTimeout(dnConf.socketKeepaliveTimeout);
